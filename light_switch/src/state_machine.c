...
int transition_machine(event_e event){
  ...
  static state m_states[] = {
      {"S0", 0, 0, 0, 0, S0_action, S0_next_state},
      {"S1", 1, 0, 0, 0, S1_action, S1_next_state},
      {"S2", 1, 1, 0, 0, S2_action, S2_next_state},
      {"S3", 0, 1, 0, 0, S3_action, S3_next_state},
      {"S4", 1, 0, 0, 0, S4_action, S4_next_state},
      {"S5", 1, 0, 0, 0, S5_action, S5_next_state}
  };
